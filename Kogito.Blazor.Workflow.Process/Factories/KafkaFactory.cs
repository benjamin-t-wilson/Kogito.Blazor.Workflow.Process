...
namespace Kogito.Blazor.Workflow.Process.Factories
{
    public class KafkaFactory : IKafkaFactory
    {
        ...
        public Task CreateConsoleConsumer(string consumerGroup, string topic)
        {
        ...
        public Task CreateConsoleConsumer(string consumerGroup, string baseUrl, string topic)
        {
            var conf = new ConsumerConfig
            {
                GroupId = consumerGroup,
        ...
        public Task CreateConsumer(string consumerGroup, string topic, List<string> output)
        {
            var conf = new ConsumerConfig
            {
                GroupId = consumerGroup,
        ...
        public Task CreateConsumer(string consumerGroup, string baseUrl, string topic, List<string> output)
        {
            var conf = new ConsumerConfig
            {
                GroupId = consumerGroup,
